...
<div class="users">
	<h3 class="bg-primary p-2 text-white">All Customer Details</h3>
	<table class="table table-bordered table-primary">
		...
		ArrayList<Customer> arr=reg.viewUsers();
		...
		for(Customer c: arr) {%>
			<tr>
				...
				<button class="btn btn-danger btn-sm text-center" name="deleteUser">Delete</button>
				</form>
				</td>
